...
The web client backend can be changed between [ureq](https://crates.io/crates/ureq) and [reqwest](https://crates.io/crates/reqwest) by inverting the comments in the client module within `coconut_crab_lib/src/web.rs`
